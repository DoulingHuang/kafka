...
def mongoappend(whiskeyname , comment):
    uri = f'mongodb://stevenjj12345:eb102@35.194.165.27:27017'
    ...
    #
    result = collection.find({"whiskey_name": whiskeyname})
    for i in result:
        i['comment'].append(comment)
        c = i['comment']
    collection.update({"whiskey_name": whiskeyname}, {"$set": {"comment": c}})
    result1 = collection.find({"whiskey_name": whiskeyname})
    for i in result1:
        print(i['comment'])
        ...
        while True:
            ...
            for record in records:
                ...
                if record.error():
                    ...
                    count += 1
                    print('{}'.format(msgValue))
                    mongoappend( 'testwhiskey' , msgValue)
